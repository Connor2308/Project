...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2024 at 01:03 PM
...
INSERT INTO `invoices` (`invoice_id`, `order_id`, `invoice_date`, `invoice_time`, `total_due`, `status`) VALUES
(5000002, 6000002, '2024-11-02', '15:00:00', 87.75, 0);
...
INSERT INTO `parts` (`part_id`, `part_name`, `description`, `genre`, `manufacturer`, `unit_price`, `quantity_in_stock`, `reorder_level`, `supplier_id`) VALUES
(3000001, 'Brake Pad', 'Standard brake pad for various models', 'Brakes', 'Brakes Inc.', 15.99, 51, 10, 8000002),
(3000002, 'Spark Plugs', 'High-performance spark plug', 'Engine', 'SparkWorks', 5.75, 120, 30, 8000003),
(3000003, 'Oil Filter', 'Premium oil filter', 'Engine', 'FilterMax', 8.25, 60, 15, 8000002),
(3000004, 'Air Filter', 'Durable air filter for improved engine performance', 'Engine', 'FilterMax', 12.50, 75, 20, 8000002),
(3000005, 'Fuel Pump', 'Reliable fuel pump for various car models', 'Fuel System', 'Auto Parts Co.', 45.75, 30, 5, 8000001),
(3000006, 'Brake Disc', 'High-quality brake disc for enhanced braking', 'Brakes', 'Brakes Inc.', 22.99, 40, 10, 8000001),
(3000007, 'Headlight Bulb', 'Long-lasting headlight bulb, compatible with most cars', 'Electrical', 'Engine Works', 9.95, 195, 50, 8000003),
(3000008, 'Windshield Wiper', 'Premium wiper for clear visibility', 'Accessories', 'Auto Parts Co.', 7.25, 150, 30, 8000001),
(3000009, 'Thermostat', 'Efficient thermostat for temperature regulation', 'Cooling System', 'Engine Works', 15.75, 60, 20, 8000003),
(3000010, 'Radiator', 'Efficient radiator for engine cooling', 'Cooling System', 'Engine Works', 95.50, 20, 5, 8000003),
(3000011, 'Battery', '12V car battery with long lifespan', 'Electrical', 'Auto Parts Co.', 120.00, 15, 3, 8000001),
(3000012, 'Timing Belt', 'Durable timing belt for precise engine performance', 'Engine', 'SparkWorks', 35.75, 49, 10, 8000003),
(3000013, 'Clutch Plate', 'High-performance clutch plate for smooth driving', 'Transmission', 'Brakes Inc.', 89.99, 25, 5, 8000001),
(3000014, 'Exhaust Muffler', 'Premium muffler for noise reduction and performance', 'Exhaust', 'Fastenings Ltd.', 45.00, 30, 8, 8000002),
(3000015, 'Fuel Injector', 'High-efficiency fuel injector for optimal combustion', 'Fuel System', 'Engine Works', 75.25, 40, 10, 8000003),
(3000017, 'Starter Motor', 'Durable starter motor for consistent engine ignition', 'Electrical', 'SparkWorks', 110.00, 12, 2, 8000003),
(3000018, 'CV Joint', 'High-quality CV joint for drive shaft durability', 'Transmission', 'Brakes Inc.', 72.50, 28, 10, 8000004),
(3000019, 'Drive Belt', 'Flexible drive belt for various car models', 'Engine', 'Fastenings Ltd.', 20.75, 50, 12, 8000002),
(3000020, 'Alternator', 'High-performance alternator for consistent charging', 'Electrical', 'PowerDrive Inc.', 150.00, 25, 5, 8000001),
(3000021, 'Water Pump', 'Reliable water pump for efficient cooling', 'Cooling System', 'CoolFlow Ltd.', 80.50, 30, 10, 8000003),
(3000022, 'Wheel Bearing', 'Durable wheel bearing for smooth rotation', 'Suspension', 'Auto Parts Co.', 35.00, 40, 12, 8000001),
(3000023, 'Control Arm', 'High-strength control arm for steering stability', 'Suspension', 'Fastenings Ltd.', 60.00, 20, 8, 8000002),
(3000024, 'Engine Mount', 'Sturdy engine mount to minimize vibrations', 'Engine', 'Engine Works', 45.75, 15, 3, 8000003),
(3000025, 'Exhaust Pipe', 'High-grade exhaust pipe for durability', 'Exhaust', 'Fastenings Ltd.', 55.00, 10, 2, 8000002),
(3000026, 'Timing Chain', 'Long-lasting timing chain for precise synchronization', 'Engine', 'SparkWorks', 70.00, 18, 6, 8000003),
(3000027, 'Battery Cable', 'Durable cable for secure battery connections', 'Electrical', 'Engine Works', 20.50, 50, 15, 8000003),
(3000028, 'Radiator Hose', 'Flexible radiator hose for efficient coolant flow', 'Cooling System', 'CoolFlow Ltd.', 18.99, 60, 20, 8000003),
(3000029, 'Brake Fluid', 'High-performance brake fluid for safety', 'Brakes', 'Brakes Inc.', 12.50, 100, 25, 8000001);
